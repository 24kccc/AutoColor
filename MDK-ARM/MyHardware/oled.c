...
void OLED_test(){
	OLED_Clear(); // 清屏
  // 上面的初始化以及清屏的代码在丿弿始处丿定要冿
  OLED_ShowString(0, 0, "UNICORN_LI", 16, 1);     // 反相显示8X16字符丿
  OLED_ShowString(0, 2, "unicorn_li_123", 12, 0); // 正相显示6X8字符丿

  OLED_ShowCHinese(0, 4, 0, 1);  // 反相显示汉字“独‿
  OLED_ShowCHinese(16, 4, 1, 1); // 反相显示汉字“角‿
  OLED_ShowCHinese(32, 4, 2, 1); // 反相显示汉字“兽‿
  OLED_ShowCHinese(0, 6, 0, 0);  // 正相显示汉字“独‿
  OLED_ShowCHinese(16, 6, 1, 0); // 正相显示汉字“角‿
  OLED_ShowCHinese(32, 6, 2, 0); // 正相显示汉字“兽‿

//   OLED_ShowNum(48, 4, 6, 1, 16, 0);     // 正相显示1使8X16数字‿6‿
//   OLED_ShowNum(48, 7, 77, 2, 12, 1);    // 反相显示2使6X8数字‿77‿
